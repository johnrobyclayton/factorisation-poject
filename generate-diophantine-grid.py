...
print(grid_2)
grid_3=generate_grid3(grid_2,moddiff(3,d%3),(d**.5)*1.2)
print(grid_3)
grid_5=generate_grid3(grid_3,moddiff(5,d%5),(d**.5)*1.2)
print(grid_5)
grid_7=generate_grid3(grid_5,moddiff(7,d%7),(d**.5)*1.2)
print(grid_7)
grid_11=generate_grid3(grid_7,moddiff(11,d%11),(d**.5)*1.2)
print(grid_11)
